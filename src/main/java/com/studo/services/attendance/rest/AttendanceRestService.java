...
public class AttendanceRestService {
    ...
    public UsersDto getUsers(@QueryParam(value = "ids") List<String> ids, @QueryParam(value = "idName") String idName) {
    ...
    @GET
    @Path("functions")
    public List<FunctionEntity> getFunctions(@QueryParam(value = "functionTypes") List<String> functionTypes) {
